  ...
  return (
    <>
      <section className="mt-10 px-6 text-center">
        <p className="text-xs uppercase tracking-[0.3em] text-primary/70 mb-2 font-medium">Patrimonio Neto</p>
        <div className="relative inline-block">
          <h1 className="text-5xl font-extrabold text-primary tracking-tight">
            ${netWorth.toLocaleString()}<span className="text-2xl font-normal opacity-80">.00</span>
          </h1>
      ...
      <section className="mt-10 px-6 grid grid-cols-2 gap-4">
        <div className="bg-card-dark rounded-xl p-4 border border-primary/10 flex flex-col gap-3">
          ...
          <div>
            <p className="text-[10px] uppercase tracking-wider text-slate-400">Ingresos</p>
            <p className="text-lg font-bold text-slate-100">${income.toLocaleString()}</p>
          </div>
        </div>
        <div className="bg-card-dark rounded-xl p-4 border border-primary/10 flex flex-col gap-3">
          ...
          <div>
            <p className="text-[10px] uppercase tracking-wider text-slate-400">Gastos</p>
            <p className="text-lg font-bold text-slate-100">${expenses.toLocaleString()}</p>
          </div>
        </div>
      </section>
    </>
